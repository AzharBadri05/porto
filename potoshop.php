...
<nav class="navbar navbar-expand-lg bg-light sticky-top">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php"><b>PORTOFOLIO</b></a>
...
<!-- Section 2 -->
    <h5>Design Photoshop</h5>
    <div class="row mb-5">
        <div class="card p-3" style="box-shadow: 1px 0px 5px #B5B5B5; border:none;">
            <div class="row g-3">
              <div class="col-6 col-sm-4 col-md-2">
                <img src="asset/ss/bg1.png" alt="foto" class="img-fluid">
              </div>
              <div class="col-6 col-sm-4 col-md-2">
                <img src="asset/ss/bg2.png" alt="foto" class="img-fluid">
              </div>
              <div class="col-6 col-sm-4 col-md-2">
                <img src="asset/ss/bgg.png" alt="foto" class="img-fluid">
              </div>
              <div class="col-6 col-sm-4 col-md-2">
                <img src="asset/ss/gbr.png" alt="foto" class="img-fluid">
              </div>
              <div class="col-6 col-sm-4 col-md-2">
                <img src="asset/ss/gbr2.png" alt="foto" class="img-fluid">
              </div>
              <div class="col-6 col-sm-4 col-md-2">
                <img src="asset/ss/gbr3.png" alt="foto" class="img-fluid">
              </div>
              <div class="col-6 col-sm-4 col-md-2">
                <img src="asset/ss/gbr4.png" alt="foto" class="img-fluid">
              </div>
              <div class="col-12">
                  <p> Hasil di atas merupakan tampilan setelah melakukan scan terhadap marker.</p>
              </div>
            </div>
        </div>
    </div>   
        ...
        <img src="asset/gambar/ftwis4.png" class="img-thumbnail" alt="foto" width="100" height="120"><br>
          ...
          <div class="row">
            <div class ="col-md-4 mb-2 mb-md-2">
              <img src="asset/gambar/foto1.jpeg" alt="foto" class="img-fluid h-80">
            </div>
